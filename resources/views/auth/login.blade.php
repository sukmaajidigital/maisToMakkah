...
<head>
    ...
    <title>Login Member - {{ env('APP_NAME') }}</title>
...
<body class="bg-gray-100 dark:bg-gray-900">
    <section class="flex items-center justify-center h-screen">
        <div class="w-full max-w-md p-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <h2 class="text-2xl font-bold text-center text-gray-900 dark:text-white mb-6">Login Member</h2>
            <form method="POST" action="{{ route('login.store') }}">
                ...
                <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Login</button>
