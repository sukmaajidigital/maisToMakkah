...
<div>
    ...
    <div class="grid gap-6 sm:grid-cols-2">
        <div>
            <x-forms.text-input type="password" label="Password" name="password" id="password" placeholder="Minimal 8 karakter" value="" :required="!isset($user)" />
        </div>
        <div>
            <x-forms.text-input type="password" label="Password Confirmation" name="password_confirmation" id="password_confirmation" placeholder="Ketik ulang password" value="" :required="!isset($user)" />
        </div>
    </div>
</div>
